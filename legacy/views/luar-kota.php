        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">List Data Karyawan Ke Luar Kota</h3>
                                ...
                                <table class="table table-bordered table-responsive nowrap example2" id="tableMain">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="background:green;color:#fff;text-align:center;">1</th>
                                            <th style="background:blue;color:#fff;text-align:center;">2</th>
                                            <th style="background:purple;color:#fff;text-align:center;">3</th>
                                            <th style="background:grey;color:#fff;text-align:center;">4</th>
                                            <th style="background:red;color:#fff;text-align:center;">6</th>
                                            <th style="background:orange;color:#fff;text-align:center;">7</th>
                                            <th style="background:#444;color:#fff;text-align:center;">8</th>
                                            <th style="background:brown;color:#fff;text-align:center;">9</th>
                                            <th style="background:#444;color:#fff;text-align:center;">10</th>
