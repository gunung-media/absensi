        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            ...
            <ol class="breadcrumb" style="background-color: #3c8dbc">
                        <li class="active" style="color: #000">
                            ...
                            <a style="color: #fff" href="">
                            / Laporan Absensi Karyawan Bulanan</a>
                        </li>
                    </ol>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> Daftar Absensi Karyawan Bulanan
                </div>
                <div class="panel-body" id="panel-body">
                    <form action="<?php echo $BaseUrl; ?>/laporan&aksi-laporan-bulanan=true&token=<?php echo $token; ?>.php" class="form-horizontal row-form" id="myForm">
