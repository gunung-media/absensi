...
$data = $database -> detailDepartemen($con,$kode);
...
if(!empty($departemen)) {
    if($departemen)
    {
        ...
        <script>
            swal({
                text: "Data Departemen berhasil di edit !!",
                icon: "success",
                type: "success"
            });
        </script>
    ...
    else    
    {
        ...
        <script>
            swal({
                text: "Data Departemen gagal di edit, Mungkin adminname sudah ada yang menggunakan !!",
                icon: "error",
                type: "error"
            });
        </script>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px; padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="fa fa-pencil"></i> Form Edit Departemen 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="nama_departemen" class="form-control" value="<?php echo $data['nama_departemen']; ?>" required>
                                        </div>
                                    </div>
