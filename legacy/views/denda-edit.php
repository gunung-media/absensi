...
$data = $database -> detailDenda($con,$kode);
...
if(!empty($denda)) {
    if($denda)
    {
        ...
        <script>
            swal({
                text: "Data Denda berhasil di edit !!",
                icon: "success",
                type: "success"
            });
        </script>
    ...
    else    
    {
        ...
        <script>
            swal({
                text: "Data Denda gagal di edit, Mungkin adminname sudah ada yang menggunakan !!",
                icon: "error",
                type: "error"
            });
        </script>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_denda" class="form-control" value="<?php echo $data['nama_denda']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" name="jml_denda" class="form-control" value="<?php echo $data['jml_denda']; ?>" onKeyup="document.getElementById('harga').innerHTML = formatCurrency(this.value);" required>
                                        </div>
                                    </div>                                   
