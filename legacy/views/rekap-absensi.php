        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            ...
            <ol class="breadcrumb" style="background-color: #3c8dbc">
                        <li class="active" style="color: #000">
                            ...
                            <a style="color: #fff" href="">
                            / Laporan Absensi Karyawan Per Tahun</a>
                        </li>
                    </ol>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> Rekap Absensi Karyawan Per Tahun
                </div>
                <div class="panel-body" id="panel-body">
                    <form action="<?php echo $BaseUrl; ?>/laporan&aksi-rekap-absensi=true&token=<?php echo $token; ?>.php" class="form-horizontal row-form" id="myForm">
                    <center>
                    ...
                    <table cellspacing="5" cellpadding="5" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                    <input type="checkbox" name="ket[]" value="cut" checked> Cuti
                                </td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                    <input type="checkbox" name="ket[]" value="tel" checked> Telat
                                </td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                    <input type="checkbox" name="ket[]" value="sak" checked> Sakit
                                </td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                    <input type="checkbox" name="ket[]" value="izi" checked> Izin Siang
                                </td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                    <input type="checkbox" name="ket[]" value="vis" checked> Visit
                                </td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                    <input type="checkbox" name="ket[]" value="lk" checked> Luar Kota
                                </td>
                            </tr>
                        </tbody>
                    </table>
