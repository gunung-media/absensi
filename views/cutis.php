...
<div class="content-wrapper">
    <div class="row">
        ...
        <!-- content -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <a href="<?php echo $BaseUrl; ?>/cuti&tambah=true&token=<?php echo $token; ?>.php"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tambah</button></a>
            <br><br>
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> List Data Cuti
                </div>
                        ...
                        <table class="table table-bordered table-striped table-responsive nowrap example2">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background:#f39c12;">TAHUN</th>
                                    <th style="background:#f39c12;">JUMLAH</th>
                            ...
                            <?php
                                $no=1;
                                $tampil = $database -> tampilCuti($con);
                                foreach($tampil as $data)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>'.$data["jml_cuti"].'</td>
                                        <td>
                                            <a href="'.$BaseUrl.'/cuti&edit='.$data["id_cuti"].'&token='.$token.'.php" class="btn btn-success btn-sm">
                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit</a>
                                            <a href="javascript:;" data-id="'.$data['id_cuti'].'" data-toggle="modal" data-target="#modal-hapus-cuti" class="btn btn-danger btn-sm">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-cuti" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
