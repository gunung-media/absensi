...
<div class="content-wrapper">
    <div class="row">
        ...
        <!-- content -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <a href="<?php echo $BaseUrl; ?>/admin&tambah=true&token=<?php echo $token; ?>.php"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tambah</button></a>
            <br><br>
                ...
                <div class="panel-body" id="panel-body">
                    <div class="table-responsive" style="overflow-x:auto;">
                        <table class="table table-bordered table-striped table-responsive nowrap example2">
                            ...
                            <?php
                                $no=1;
                                $tampil = $database -> tampilAdmin($con);
                                foreach($tampil as $data)
                                {
                                    ...
                                    <tr>
                                        ...
                                        echo '
                                        <td>
                                            <a href="'.$BaseUrl.'/admin&edit='.$data["id_login"].'&token='.$token.'.php" class="btn btn-success btn-sm">
                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit</a>
                                            <a href="javascript:;" data-id="'.$data['id_login'].'" data-toggle="modal" data-target="#modal-hapus-admin" class="btn btn-danger btn-sm">
