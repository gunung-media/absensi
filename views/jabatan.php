...
<div class="content-wrapper">
    <div class="row">
        ...
        <!-- content -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <a href="<?php echo $BaseUrl; ?>/jabatan&tambah=true&token=<?php echo $token; ?>.php"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tambah</button></a>
            <br><br>
                            ...
                            <?php
                                ...
                                foreach($tampil as $data)
                                {
                                    ...
                                    <tr>
                                        ...
                                        echo '
                                        <td>
                                            <a href="'.$BaseUrl.'/jabatan&edit='.$data["id_jabatan"].'&token='.$token.'.php" class="btn btn-success btn-sm">
                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit</a>
                                            <a href="javascript:;" data-id="'.$data['id_jabatan'].'" data-toggle="modal" data-target="#modal-hapus-jabatan" class="btn btn-danger btn-sm">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-jabatan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
