...
$data = $database -> detailJabatan($con,$kode);
...
if(!empty($jabatan)) {
    if($jabatan)
    {
        ...
        <script>
            swal({
                text: "Data Jabatan berhasil di edit !!",
                icon: "success",
                type: "success"
            });
        </script>
    ...
    else    
    {
        ...
        <script>
            swal({
                text: "Data Jabatan gagal di edit, Mungkin adminname sudah ada yang menggunakan !!",
                icon: "error",
                type: "error"
            });
        </script>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px; padding-right: 20px">
            <div>
                <ol class="breadcrumb" style="background-color: #3c8dbc">
                  <li class="active" style="color: #fff"><a style="color: #fff" href=""><i class="fa fa-cube"></i> Master Data /</a> Jabatan</li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px; padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="fa fa-pencil"></i> Form Edit Jabatan 
                    <a href="<?php echo $BaseUrl; ?>/jabatan.php"><button type="button" class="btn btn-sm" style="float:right;background-color:#ffffff;color:#000;line-height:0.8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="nama_jabatan" class="form-control" value="<?php echo $data['nama_jabatan']; ?>" required>
                                        </div>
                                    </div>
