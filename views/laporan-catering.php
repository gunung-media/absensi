        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> Daftar Uang Catering Karyawan
                </div>
                <div class="panel-body" id="panel-body">
                    <form action="<?php echo $BaseUrl; ?>/laporan&aksi-laporan-catering=true&token=<?php echo $token; ?>.php" class="form-horizontal row-form" id="myForm">
