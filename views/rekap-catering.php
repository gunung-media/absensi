        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> Daftar Absensi Catering Karyawan
                </div>
                <div class="panel-body" id="panel-body">
                    <form action="<?php echo $BaseUrl; ?>/laporan&aksi-rekap-catering=true&token=<?php echo $token; ?>.php" class="form-horizontal row-form" id="myForm">
                    <table cellspacing="5" cellpadding="5" border="0">
                        <tbody>
                             <tr>
                                <td><input type="text" id="keyword1" name="tglawal" class="form-control tglawal" placeholder="Dari" required></td>
                                <td>&nbsp;</td>
                                <td><input type="text" id="keyword2" name="tglakhir" class="form-control tglakhir" placeholder="Sampai" required></td>
                                <td>&nbsp;</td>
                                <td>
